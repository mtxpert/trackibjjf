...
MATTRACK_URL  = os.environ.get("MATTRACK_URL",  "https://www.mattrack.net")
TRACKBJJ_URL  = os.environ.get("TRACKBJJ_URL",  "https://www.trackbjj.net")

@app.context_processor
def inject_header_vars():
    return dict(
        site_name="MatTrack",
        site_subtitle="Live Tournament Tracker",
        site_url=MATTRACK_URL,
        site_icon="🥋",
        sibling_name="TrackBJJ",
        sibling_url=TRACKBJJ_URL,
        header_home_fn="goHome()",
        show_lang=True,
    )
